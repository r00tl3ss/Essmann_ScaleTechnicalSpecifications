...
class JSONConverter:
    PATH = '/Users/timon/Desktop/Essmann/tests/Prompts/'
    def __init__(self):
        pass
            ...
            for filename in os.listdir(cls.PATH):
                ...
                if os.path.isfile(file_path):
                    ...
                    with open(file_path, 'r', encoding='utf-16-le') as file:
                        ...
                        #jsonfilename = technicalsheet.cut_last_path_part(file_path) + ".json"
                        #jsoncontent = cls.extract_json_and_save_to_file(response, jsonfilename)
